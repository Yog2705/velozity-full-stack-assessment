...
const seed = async () => {
  ...
  const projectOne = await prisma.project.upsert({
    ...
    update: {
      ...
      description:
        "Sample project management platform for assessment testing.",
      clientId: client.id,
  ...
  const projectTwo = await prisma.project.upsert({
    ...
    update: {
      ...
      description:
        "E-commerce project containing tasks across different priorities and statuses.",
      clientId: client.id,
      createdById: projectManagerOne.id,
    },
    create: {
  ...
  const projectThree = await prisma.project.upsert({
    ...
    update: {
      ...
      description:
        "Mobile application project owned by the second project manager.",
      clientId: client.id,
  ...
  await prisma.task.upsert({
    ...
    update: {
      ...
      description:
        "Create the initial dashboard design.",
  ...
  await prisma.task.upsert({
    ...
    update: {
      ...
      description:
        "Document the project management API.",
      projectId: projectOne.id,
  ...
  await prisma.task.upsert({
    ...
    update: {
      ...
      description:
        "Implement task creation, update and filtering endpoints.",
      projectId: projectOne.id,
  ...
  await prisma.task.upsert({
    ...
    update: {
      ...
      description:
        "Resolve an authentication issue discovered during testing.",
      projectId: projectOne.id,
      assignedDeveloperId: developerOne.id,
      status: "IN_PROGRESS",
      priority: "CRITICAL",
  ...
  await prisma.task.upsert({
    ...
    update: {
      ...
      description:
        "Build the product catalogue interface.",
  ...
  await prisma.task.upsert({
    ...
    update: {
      ...
      description:
        "Create customer order history functionality.",
      projectId: projectTwo.id,
      assignedDeveloperId: developerOne.id,
      status: "DONE",
      priority: "LOW",
  ...
  await prisma.task.upsert({
    ...
    update: {
      ...
      description:
        "Fix validation issues in the checkout process.",
      projectId: projectTwo.id,
      assignedDeveloperId: developerTwo.id,
      status: "TODO",
      priority: "HIGH",
  ...
  await prisma.task.upsert({
    ...
    update: {
      ...
      description:
        "Build the mobile login interface.",
  ...
  await prisma.task.upsert({
    ...
    update: {
      ...
      description:
        "Create the mobile dashboard screen.",
      projectId: projectThree.id,
      assignedDeveloperId: developerOne.id,
      status: "IN_REVIEW",
      priority: "HIGH",
  ...
  await prisma.task.upsert({
    ...
    update: {
      ...
      description:
        "Implement offline synchronization for mobile users.",
      projectId: projectThree.id,
      assignedDeveloperId: developerTwo.id,
      status: "DONE",
      priority: "CRITICAL",
  ...
  await prisma.task.upsert({
    ...
    update: {
      ...
      description:
        "Optimise API calls for mobile performance.",
      projectId: projectThree.id,
      assignedDeveloperId: developerFour.id,
      status: "IN_PROGRESS",
      priority: "MEDIUM",
  ...
  await prisma.notification.upsert({
    ...
    update: {
      ...
      message:
        "You have been assigned a new task: Design project dashboard",
      isRead: false,
      readAt: null,
    },
    create: {
  ...
  await prisma.notification.upsert({
    ...
    update: {
      ...
      message:
        "You have an overdue task: Fix checkout validation",
      isRead: false,
      readAt: null,
    },
    create: {
